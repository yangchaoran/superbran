...
<!--展示区  -->
	<div id="introduce">
		<div class="box">
			<ul class="int">
				<li class="by1"><a href="<?php echo $GATEGORYS['about']['url'];?>"></a></li>
				<li class="by2"><a href="<?php echo $GATEGORYS['product']['url'];?>"></a></li>
				<li class="by3"><a href="<?php echo $GATEGORYS['contact']['url'];?>"></a></li>
			</ul>
		</div>
	</div>
<!-- 网页底部 -->
