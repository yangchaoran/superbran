...
'cookie_pre' => 'PxDtu_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://superbran.duapp.com/linfen/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://superbran.duapp.com/linfen/statics/js/', //CDN JS
'css_path' => 'http://superbran.duapp.com/linfen/statics/css/', //CDN CSS
'img_path' => 'http://superbran.duapp.com/linfen/statics/images/', //CDN img
'app_path' => 'http://superbran.duapp.com/linfen/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'y9SMBCVgrD1yaIvryYY4', //密钥
'lang' => 'zh-cn',  //网站语言包
'<loc></loc>k_ex' => '1',  //写入缓存时是否建立文件互斥锁定（如果使用nfs建议关闭）
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://superbran.duapp.com/linfen/phpsso_server',	//接口地址
'phpsso_auth_key' => '8mwZq9I6mmEXPg7LdKyw9S9SaTglpqpf', //加密密钥
