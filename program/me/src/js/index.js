                ...
                <ul className="list col-md-12 col-sm-12 col-sm-12">
                    ...
                    <li className="col-md-4 col-sm-6 col-xs-12">
                        <a href="work/dailyweb/index.html">
                            <div className="entry">移动端web应用</div>
                        </a>
                    </li>
                    <li className="col-md-4 col-sm-6 col-xs-12">
                    ...
                    <li className="col-md-4 col-sm-6 col-xs-12">
                        <a href="work/linfen/index.html">
                            <div className="entry">临汾方圆项目</div>
                        </a>
                    </li>
                </ul>
            </div>
    ...
    render() {
        return (
            <section className="main">
                ...
                <div className="mainLeft col-md-12 col-sm-10 col-xs-12">
                    <h2 className="col-md-12 col-sm-10 col-xs-12">我是<h1>杨超</h1></h2>
                    <h2 className="col-md-12 col-sm-10 col-xs-12">职业：前端攻城狮</h2>
                    <h3 className="col-md-12 col-sm-10 col-xs-12">写的更少，做的更多</h3>
                </div>
